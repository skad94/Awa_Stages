...
cSquareMatrix::cSquareMatrix(int size):_size(size),_data(_size*_size,0) {}

cSquareMatrix::cSquareMatrix(const cSquareMatrix& m):_size(m._size),_data(m._data) {}

cSquareMatrix::~cSquareMatrix() {}

double& 
cSquareMatrix::operator()(int i, int j) 
{
    return _data[i*_size + j];
}

double 
cSquareMatrix::operator()(int i, int j) const 
{
    return _data[i*_size + j];
}
